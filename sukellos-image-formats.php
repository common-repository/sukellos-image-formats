<?php
/**
 * Plugin Name: Sukellos - Image Formats
 * Plugin URI: https://wp-adminbuilder.com/image-formats/
 * Description: Sukellos Framework Tools - Image Formats
 * Version: 1.1.8
 ...
 *
 *
 * @package   WP-Sukellos-Image-Formats
 * @author    Sukellos
 * @category  Admin
 ...
 * @since 1.0.0
 */
final class WP_Sukellos_Image_Formats_Loader extends WP_Sukellos_Fw_Loader {
    ...
    public function get_plugin() {
        ...
        return WP_Sukellos_Image_Formats::instance();
    }
    ...
    public function get_plugin_admin() {
        ...
        return WP_Sukellos_Image_Formats_Admin::instance();
    }
}
WP_Sukellos_Image_Formats_Loader::instance();