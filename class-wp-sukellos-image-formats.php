 ...
 * @since 1.0.0
 */
class WP_Sukellos_Image_Formats extends WP_Plugin {
    ...
    public function init() {
        ...
        load_plugin_textdomain( WP_Sukellos_Image_Formats_Loader::instance()->get_text_domain(), false, WP_Sukellos_Image_Formats_Loader::instance()->get_text_domain().'/languages/' );

        self::$instance->enable_admin();

        Images_Manager::instance();
    }
